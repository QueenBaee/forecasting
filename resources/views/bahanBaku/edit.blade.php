          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit Data Bahan Baku</h5>
                ...
                <form action="{{  url('bahanBaku/update/'.$bahanBaku->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Bahan Baku</label>
                  <div class="col-sm-10">
                    <input type="text" name="nama" id="nama" class="form-control"value="{{ $bahanBaku->nama_bahanBaku }}">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Jenis</label>
                  <div class="col-sm-10">
                    <input type="text" name="jenis" id="jenis" class="form-control"value="{{ $bahanBaku->jenis }}">
                  </div>
                </div>
