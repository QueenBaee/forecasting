                    ...
                    <div class="nav-inner">
                        ...
                        <nav class="navbar navbar-expand-lg">
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="#features" class="page-scroll"
                                            aria-label="Toggle navigation">Testimoni</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#pricing" class="page-scroll"
                                            aria-label="Toggle navigation">Daftar Produk</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="button add-list-button">
                                <a href="/login" class="btn">Login Disini</a>
                            </div>
                        </nav>
                        <!-- End Navbar -->
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-12 col-12">
                    <div class="hero-content">
                        <h1 class="wow fadeInLeft" data-wow-delay=".4s">Salama Meat Shop</h1>
                        <p class="wow fadeInLeft" data-wow-delay=".6s">Menyediakan berbagai jenis daging impor beku
                            Sekaligus menyewakan peralatan grill yang murah dan terjangkau.</p>
                        <div class="button wow fadeInLeft" data-wow-delay=".8s">
                            <a href="javascript:void(0)" class="btn"><i class="lni lni-whatsapp"></i> Whatsapp</a>
                            <a href="https://www.instagram.com/salamameatshop" class="btn btn-alt"><i class="lni lni-instagram"></i> 
                                Instaram</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 col-md-12 col-12">
                    <div class="hero-image wow fadeInRight" data-wow-delay=".4s">
                        <img src="{{asset('assets/images/hero/promo.jpg')}}" height="460px" alt="#">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h3 class="wow zoomIn" data-wow-delay=".2s">Testimoni Pelanggan</h3>
